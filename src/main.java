...
public class main extends JFrame {
    ...
    public JTextField txtStockSearch,txtStockID,txtStockName,txtStockDes,
    					txtStockOnHand,txtStockPrice,txtUsersSearch,txtEditUsername,txtUserID,txtUserFirstName,txtUserLastName,txtSalesSearch,txtClientIDSearch,txtCliendId,txtName,txtPhone,txtItemID,txtNameItem,txtPrice,txtQuantity;
...
;			}
			...
			if(validateStockInfo())
			{
				if(saveMode == "new") {
					st.executeUpdate("INSERT INTO lpa_stock "
							...
							+ txtStockOnHand.getText() + "," + txtStockPrice.getText() + ",'a');");
				} else {
					st.executeUpdate(
	...
	{
		try {
			ifAbout = new JInternalFrame("About");
			...
			// Getting the url with the html file path
			URL about = ClassLoader.getSystemResource("about.html");
			JEditorPane editorpane = new JEditorPane();
			editorpane.setEditable(false);
			editorpane.setPage(about);
